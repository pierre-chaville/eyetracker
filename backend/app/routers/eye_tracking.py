...
@router.post("/api/eye-tracking/start", response_model=MessageResponse)
...
@router.post("/api/eye-tracking/stop", response_model=MessageResponse)
...
@router.get("/api/eye-tracking/status", response_model=EyeTrackingStatus)
